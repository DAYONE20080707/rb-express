...
const Privacy_01 = () => {
  return (
    <div className="md:max-w-[1000px] px-5 mx-auto py-[96px] text-base font-normal leading-[160%]">
      <div>
        株式会社アールビー（以下、「当社」といいます。）は、本ウェブサイト上で提供するサービスにおける個人情報保護の重要性について認識し、個人情報の保護に関する法律を遵守すると共に、以下のプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。
      </div>
      <ul className="mt-[64px] space-y-10">
        ...
        <li>
          ...
          <p>
            ...
            担当部署：個人情報保護管理責任者
            <br />
            {/* Eメールアドレス：info@company.co.jp
            <br /> */}
            {new Date().getFullYear()}年{new Date().getMonth() + 1}月
            {new Date().getDate()}日改定
          </p>
        </li>
      </ul>
